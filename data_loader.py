...
class Dataset_Biovid_image_binary_class(torch.utils.data.Dataset):
    def __init__(self,PATH_IMG,PATH_ANOT,transform = lambda x: x,IDs = None,set_type = None,nb_image = None,preload=False,loaded_resolution=224, seed=42):
...
class DualTrainDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,PATH_IMG,PATH_ANOT1,PATH_ANOT2,transform = lambda x: x,IDs = None,set_type = None,nb_image = None, preload=False,loaded_resolution=224, seed=42):
        self.PATH_IMG = PATH_IMG
    ...
    def __getitem__(self,idx):
        ...
        while(self.dataframe2.loc[index2,'pain']==self.dataframe1.loc[index,'pain']):
                #print(self.dataframe1.loc[index,'pain'])
                index2=random.randint(0, len(self.dataframe2)-1)
                #print(index2)
