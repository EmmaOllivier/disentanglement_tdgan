...
def train(hpar_dict):
    ...
    biovid_annot_test = '/export/livia/home/vision/Eollivier/Biovid/test.csv'
    ...
    for fold in range(0, Fold+1):


        print(f"Fold {fold}")
        print("-------")

        biovid_annot_train="/export/livia/home/vision/Eollivier/Biovid_corrected/train"+str(fold)+"_order.csv"
        biovid_annot_val = "/export/livia/home/vision/Eollivier/Biovid_corrected/valid"+str(fold)+"_order.csv"
        dataset_train = data_loader.DualTrainDataset(Biovid_img_all,biovid_annot_train,biovid_annot_train,transform = tr.transform,IDs = None,nb_image = None,nb_fold=1,preload=False)
        ...
        save_dir = "/export/livia/home/vision/Eollivier/models/experience_GAN_Biovid_protocole_fold_deterministic_Biovid_corrected/"+str(fold)+"/"
        if not os.path.exists(save_dir):
            os.makedirs(save_dir)

        img_dir = "/export/livia/home/vision/Eollivier/models/experience_GAN_Biovid_protocole_fold_deterministic_Biovid_corrected/"+str(fold)+"/img/"
        ...
        for e in range(1, epoch + 1):
            ...
            if e % VAL_GAP == 0:
                ...
                with torch.no_grad():
                    ...
                    Dis_ER_val.eval()
                    tt_acc, tt_ce = util2.Val_acc(val_loader, Dis_ER_val, CE, hpar_dict['device'], e, epoch)
                    ...
                    Dis_ER.eval()
                    tt_acc_ExpDis, tt_ce_ExpDis = util2.Val_acc(val_loader, Dis_ER, CE, hpar_dict['device'], e, epoch)
